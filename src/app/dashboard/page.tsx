    ...
    <div className="min-h-screen relative text-white selection:bg-[#f3b5a1] selection:text-[#233529] overflow-x-hidden flex flex-col">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <Link
                href="/"
                className="text-3xl font-medium tracking-wide text-white hover:text-white/80 transition-colors cursor-pointer"
      ...
      <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 py-12 flex flex-col gap-12">
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="backdrop-blur-xl bg-white/5 border border-white/10 shadow-xl rounded-2xl p-8 relative overflow-hidden group"
          >
          ...
          <motion.div
            variants={fadeUp}
            className="backdrop-blur-xl bg-white/5 border border-white/10 shadow-xl rounded-2xl p-8 flex flex-col justify-between items-start relative overflow-hidden group"
          >
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 shadow-xl rounded-2xl p-6 lg:p-8 flex flex-col relative overflow-hidden">
            ...
            <div className="grid grid-cols-7 gap-1 md:gap-2 relative z-10">
              {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((day) => (
                <div
                  key={day}
                  className="text-center text-xs font-medium text-white/40 uppercase tracking-widest mb-2"
                >
                  {day}
                </div>
              ))}
              ...
              {days.map((day) => {
                ...
                return (
                  ...
                  >
                    ...
                    {hasTodos && (
                      <span
                        className={`w-1 h-1 rounded-full absolute bottom-1 ${isSelected ? "bg-[#233529]" : "bg-[#f3b5a1]"}`}
                      ></span>
                    )}
                  </motion.button>
                );
          ...
          <div className="lg:col-span-2 backdrop-blur-xl bg-white/5 border border-white/10 shadow-xl rounded-2xl p-6 lg:p-8 flex flex-col relative overflow-hidden h-[450px]">
            ...
            <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4 relative z-10">
              ...
              <span className="text-white/40 text-sm font-light">
                {todosForSelectedDate.filter((t) => t.completed).length} /{" "}
                {todosForSelectedDate.length} completed
              </span>
            </div>
                ...
                todosForSelectedDate.map((todo) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`text-[15px] font-light transition-all ${todo.completed ? "text-white/30 line-through" : "text-white/80"}`}
                      >
                        {todo.text}
                      </span>
                    </button>
            ...
            <form
              ...
              className="mt-6 relative z-10 flex gap-3"
            >
          ...
          {loadingDesigns ? (
            ...
            <div className="w-full min-h-[400px] flex flex-col items-center justify-center backdrop-blur-md bg-white/[0.02] border border-white/10 border-dashed p-12 rounded-2xl">
              ...
              <p className="text-white/50 font-light mb-8 max-w-sm text-center">
                Your stunning room designs will appear here. Create your first
                ...
                >
                  ...
                  <div className="flex items-center gap-8">
                    <div className="hidden md:flex flex-col items-end">
                      <span className="text-xs text-white/40 uppercase tracking-wider font-medium mb-1">
                        Last Updated
                      </span>
                      <div
