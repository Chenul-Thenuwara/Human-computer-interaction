...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#233529] text-white overflow-hidden selection:bg-[#f3b5a1] selection:text-[#233529]">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        >
          ...
          <nav className="hidden md:flex gap-10 text-[15px] font-light tracking-wide font-sans">
            ...
            <Link href="#" className="hover:text-[#f3b5a1] transition-colors">Products</Link>
            <Link href="#" className="hover:text-[#f3b5a1] transition-colors">Gallery</Link>
          ...
          <div className="flex gap-6 items-center">
            <button aria-label="Search" className="hover:text-[#f3b5a1] transition-colors">
              <Search className="w-5 h-5 stroke-[1.5]" />
            </button>
            <button 
              aria-label="User profile" 
              className="border border-white/30 p-2.5 flex items-center justify-center rounded-full hover:bg-white hover:text-[#233529] transition-all"
              onClick={() => router.push(user ? '/design/new' : '/login')}
            >
