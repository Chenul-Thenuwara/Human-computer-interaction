          ...
          <div className="mb-10">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-[#4a5d5a] rounded-full flex items-center justify-center">
                <Users className="w-8 h-8 text-[#8a9d96]" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-[#2d3e3c] rounded-xl p-4 border border-[#4a5d5a]">
                <p className="text-xs text-[#a8b5b1] mb-1">Total Users</p>
                <p className="text-3xl font-serif text-[#8a9d96]">
                  {stats.total}
                </p>
              </div>
              <div className="bg-[#2d3e3c] rounded-xl p-4 border border-[#4a5d5a]">
                <p className="text-xs text-[#a8b5b1] mb-1">Admins</p>
                <p className="text-3xl font-serif text-[#8a9d96]">
                  {stats.admins}
                </p>
              </div>
              <div className="bg-[#2d3e3c] rounded-xl p-4 border border-[#4a5d5a]">
                <p className="text-xs text-[#a8b5b1] mb-1">Active</p>
                <p className="text-3xl font-serif text-[#8a9d96]">
                  {stats.activeUsers}
                </p>
              </div>
